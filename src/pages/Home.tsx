    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden bg-slate-900">
          ...
          <div className="absolute inset-0 z-20 bg-slate-900/40 mix-blend-multiply" />
          <div className="absolute inset-0 z-20 bg-gradient-to-tr from-[#f59e0b]/10 via-transparent to-[#f59e0b]/30 mix-blend-soft-light" />
        </div>
